...
public final class SharedWaypointsRenderer {
    ...
    public static void renderList(GuiGraphics g,
        ...
        int scroll = SharedWaypointsClientStorage.getScrollOffset();
        ...
        for (int i = 0; i < entries.size(); i++) {
            SharedWaypointEntry e = entries.get(i);
    ...
    private static void drawEntry(GuiGraphics g, SharedWaypointEntry e, int x, int y) {
